        ...
        const mockUser = {
          ...
          schedule: [
            { id: "1", day: "Mon", activities: [] },
            {
              id: "2",
              day: "Tue",
              activities: [{ type: "Workshop", icon: "🎨", time: "10:00 - 12:00", location: "Design Studio" }]
            },
            {
              id: "3",
              day: "Wed",
              activities: [{ type: "Event Setup", icon: "🏗️", time: "08:00 - 14:00", location: "Grand Hotel" }]
            },
            { id: "4", day: "Thu", activities: [] },
            {
              id: "5",
              day: "Fri",
              activities: [{ type: "Wedding", icon: "💒", time: "15:00 - 23:00", location: "Beach Resort" }]
            }
          ],
          friends: [
              ...
              <YStack space="$4">
                ...
                >
                  ...
                  <Paragraph color="$color11">
                    Passionate about creating unforgettable moments through beautiful floral designs and meticulous
                    event styling. Specializing in luxury weddings and corporate events with a focus on sustainable
                ...
                >
                  ...
                  <XStack
                    ...
                    gap="$2"
                  >
                    {["Weddings", "Corporate Events", "Floral Design", "Event Styling", "Sustainable Events"].map(
                      (tag) => (
                        <View
                          key={tag}
                          bg="$color4"
