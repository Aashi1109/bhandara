import { createV5Theme, defaultChildrenThemes, v5ComponentThemes } from "@tamagui/config/v5";
...
export const themes: Themes =
  process.env.TAMAGUI_ENVIRONMENT === "client" && process.env.NODE_ENV === "production" ? ({} as unknown as Themes) : (builtThemes as unknown as Themes);
